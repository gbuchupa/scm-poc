...
var CouchDBKeyValueStore = class extends api.KeyValueStore {
	 ...
	 * @scmpocy {string} url The CouchDB instance url, in the form of http(s)://<user>:<password>@host:port
	 * @scmpocy {string} name Optional. Identifies the name of the database to use. Default: <code>member_db</code>.
	 */
