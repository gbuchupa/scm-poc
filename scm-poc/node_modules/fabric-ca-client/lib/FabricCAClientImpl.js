 ...
 * @scmpocy {string[]} trustedRoots Array of PEM-encoded trusted root certificates
 * @scmpocy {boolean} [verify=true] Determines whether or not to verify the server certificate when using TLS
 */
...
var FabricCAServices = class extends BaseClient {
	 ...
	 * @scmpocy {string} enrollmentID - ID which will be used for enrollment
	 * @scmpocy {string} enrollmentSecret - Optional enrollment secret to set for the registered user.
	 *                    If not provided, the server will generate one.
	 * @scmpocy {string} role - Optional arbitrary string representing a role value for the user
	 * @scmpocy {string} affiliation - Affiliation with which this user will be associated,
	 *                    like a company or an organization
	 * @scmpocy {number} maxEnrollments - The maximum number of times this user will be permitted to enroll
	 * @scmpocy {KeyValueAttribute[]} attrs - Array of {@link KeyValueAttribute} attributes to assign to the user
	 */
	 ...
	 * @scmpocy {string} enrollmentID - The registered ID to use for enrollment
	 * @scmpocy {string} enrollmentSecret - The secret associated with the enrollment ID
	 * @scmpocy {string} profile - The profile name.  Specify the 'tls' profile for a TLS certificate;
	 *                   otherwise, an enrollment certificate is issued.
	 * @scmpocy {AttributeRequest[]} attr_reqs - An array of {@link AttributeRequest}
	 */
	 ...
	 * @scmpocy {Date} revokedBefore - Include certificates that were revoked before this UTC timestamp (in RFC3339 format) in the CRL
	 * @scmpocy {Date} revokedAfter - Include certificates that were revoked after this UTC timestamp (in RFC3339 format) in the CRL
	 * @scmpocy {Date} expireBefore - Include revoked certificates that expire before this UTC timestamp (in RFC3339 format) in the CRL
	 * @scmpocy {Date} expireAfter - Include revoked certificates that expire after this UTC timestamp (in RFC3339 format) in the CRL
	 */
	 ...
	 * @scmpocy {string} hostname
	 * @scmpocy {number} port
	 * @scmpocy {string} protocol
	 */
...
var FabricCAClient = class {
	 ...
	 * @scmpocy {string} name The key used to reference the attribute
	 * @scmpocy {string} value The value of the attribute
	 * @scmpocy {boolean} ecert Optional, A value of true indicates that this attribute
	 ...
	 * @scmpocy {string} name - The name of the attribute to include in the certificate
	 * @scmpocy {boolean} optional - throw an error if the identity does not have the attribute
	 */

	/**
	 * @typedef {Object} EnrollmentResponse
	 * @scmpocy {string} enrollmentCert PEM-encoded X509 enrollment certificate
	 * @scmpocy {string} caCertChain PEM-encoded X509 certificate chain for the issuing
