...
class IdentityService {
	 ...
	 * @scmpocy {string} enrollmentID - Required. The enrollment ID which uniquely identifies an identity
	 * @scmpocy {string} affiliation - Required. The affiliation path of the new identity
	 * @scmpocy {KeyValueAttribute[]} attrs - Array of {@link KeyValueAttribute} attributes to assign to the user
	 * @scmpocy {string} type - Optional. The type of the identity (e.g. *user*, *app*, *peer*, *orderer*, etc)
	 * @scmpocy {string} enrollmentSecret - Optional. The enrollment secret.  If not provided, a random secret is generated.
	 * @scmpocy {number} maxEnrollments - Optional. The maximum number of times that the secret can be used to enroll.
	 ...
	 * @scmpocy {string} caname - Optional. Name of the CA to send the request to within the Fabric CA server
	 */

	/**
	 * @typedef {Object} ServiceResponseMessage
	 * @scmpocy {number} code - Integer code denoting the type of message
	 * @scmpocy {string} message - A more specific message
	 */

	/**
	 * @typedef {Object} ServiceResponse
	 * @scmpocy {boolean} Success - Boolean indicating if the request was successful
	 * @scmpocy {Object} Result - The result of this request
	 * @scmpocy {ServiceResponseMessage[]} Errors - An array of error messages (code and message)
	 * @scmpocy {ServiceResponseMessage[]} Messages - An array of information messages (code and message)
	 */
