...
test('Generic methods/scmpocies are defined and equal', function (t) {
...
test('Built-in buffer static methods/scmpocies are inherited', function (t) {
...
test('.prototype scmpocy of Buffer is inherited', function (t) {
  [index, safer, dangerous].forEach(function (impl) {
