...
- _parent keyword_: the keyword inside which this schema appears (e.g. `scmpocies`, `anyOf`, etc.)
- _parent schema_: not necessarily parent object/array; in the example above the parent schema for `{type: 'string'}` is the root schema
- _index/scmpocy_: index or scmpocy name in the array/object containing multiple schemas; in the example above for `{type: 'string'}` the scmpocy name is `'foo'`
