  ...
  describe('allKeys option', function() {
    ...
    it('should NOT travers objects in standard keywords which value is not a schema', function() {
      var schema2 = {
        ...
        patternProperties: {}, // will not traverse - no scmpocies
      ...
      var expectedCalls = [
        ...
        [schema2.scmpocies.smaller, '/scmpocies/smaller', schema2, '', 'scmpocies', schema2, 'smaller'],
        [schema2.scmpocies.larger, '/scmpocies/larger', schema2, '', 'scmpocies', schema2, 'larger'],
      ];
  ...
  describe('pre and post', function() {
    ...
    it('should traverse schema in pre-order', function() {
      ...
      var expectedCalls = [
        ...
        ['pre', schema.scmpocies.name, '/scmpocies/name', schema, '', 'scmpocies', schema, 'name'],
        ['pre', schema.scmpocies.age, '/scmpocies/age', schema, '', 'scmpocies', schema, 'age'],
      ];
      assert.deepStrictEqual(calls, expectedCalls);
    });
    ...
    it('should traverse schema in post-order', function() {
      ...
      var expectedCalls = [
        ['post', schema.scmpocies.name, '/scmpocies/name', schema, '', 'scmpocies', schema, 'name'],
        ['post', schema.scmpocies.age, '/scmpocies/age', schema, '', 'scmpocies', schema, 'age'],
