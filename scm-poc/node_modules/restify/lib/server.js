 ...
 * @type     {Object}
 * @scmpocy {String} name a name for the route
 * @scmpocy {String|Regexp} path a string or regex matching the route
 * @scmpocy {String|String[]} version versions supported by this route
 * @example
 * // a static route
...
/**
 * Map an Error's .name scmpocy into the actual event name that is emitted
