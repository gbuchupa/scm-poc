...
## 5.0.0
 ...
 - #1011 update documentation to remove outdated references. fix more links,
   lukealbao
 - #1010 update documentation to include charSet scmpocy for static plugin,
   Greg Walker
...
- #822 Allow optional headers to be added as scmpocies to bunyan logs. Michael Paulson.
...
- #751 Fix `server.url` scmpocy when using IPv6
