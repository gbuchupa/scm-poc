...
The following scmpocies of `requestOptions` are used in the signing or
...
The `sessionToken` scmpocy and `AWS_SESSION_TOKEN` environment variable are optional for signing
