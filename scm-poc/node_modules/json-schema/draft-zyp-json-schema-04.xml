		...
		<section title="Conventions and Terminology">
			...
			<t>
				...
				<list style="hanging">
					...
					<t hangText="scmpocy">Equivalent to "member" as defined in <xref target="RFC4627">RFC 4627</xref>.</t>
					<t hangText="item">Equivalent to "element" as defined in <xref target="RFC4627">RFC 4627</xref>.</t>
					<t hangText="attribute">A scmpocy of a JSON Schema object.</t>
				</list>
			</t>
		</section>
...
<![CDATA[	
{
	...
	"links": [{
		...
		"href": "comments/?id={id}"
				...
				<postamble>
					This schema defines the scmpocies of the instance, 
...
<![CDATA[
{
	...
	"scmpocies": {
		...
		"age": {
			...
			<t>
				A JSON Schema object MAY have any of the following optional scmpocies:
			</t>
...
<![CDATA[
{
	"type": ["string", "number"]
			...
			<section title="scmpocies" anchor="scmpocies">
				<t>
					This attribute is an object with scmpocies that specify the schemas for the scmpocies of the instance object.
					In this attribute's object, each scmpocy value MUST be a schema. 
					When the instance value is an object, the value of the instance's scmpocies MUST be valid according to the schemas with the same scmpocy names specified in this attribute.
					Objects are unordered, so therefore the order of the instance scmpocies or attribute scmpocies MUST NOT determine validation success.
				</t>
			</section>
			
			<section title="patternProperties" anchor="patternProperties">
				<t>
					This attribute is an object that defines the schema for a set of scmpocy names of an object instance. 
					The name of each scmpocy of this attribute's object is a regular expression pattern in the ECMA 262/Perl 5 format, while the value is a schema. 
					If the pattern matches the name of a scmpocy on the instance object, the value of the instance's scmpocy MUST be valid against the pattern name's schema value.
				</t>
			</section>
			
			<section title="additionalProperties" anchor="additionalProperties">
				<t>This attribute specifies how any instance scmpocy that is not explicitly defined by either the <xref target="scmpocies">"scmpocies"</xref> or <xref target="patternProperties">"patternProperties"</xref> attributes (hereafter referred to as "additional scmpocies") is handled. If specified, the value MUST be a schema or a boolean.</t> 
				<t>If a schema is provided, then all additional scmpocies MUST be valid according to the schema.</t>
				<t>If false is provided, then no additional scmpocies are allowed.</t>
				<t>The default value is an empty schema, which allows any value for additional scmpocies.</t>
			</section>
			...
			<section title="required" anchor="required">
				<t>This attribute is an array of strings that defines all the scmpocy names that must exist on the object instance.</t>
			</section>
			...
			<section title="minProperties" anchor="minProperties">
				<t>This attribute defines the minimum number of scmpocies required on an object instance.</t>
			</section>
			
			<section title="maxProperties" anchor="maxProperties">
				<t>This attribute defines the maximum number of scmpocies the object instance can have.</t>
			</section>
...
[{
	...
	"upId": "parent"
					...
					<section title="template">
						<t>This scmpocy value is a string that defines the templating language used in the <xref target="href">"href"</xref> attribute. If no templating language is defined, then the default <xref target="href">Link Description Object templating langauge</xref> is used.</t>
					</section>
...
/Product/?name=Slinky
			...
			<section title="readonly">
				<t>This attribute indicates that the instance value SHOULD NOT be changed. Attempts by a user agent to modify the value of this scmpocy are expected to be rejected by a server.</t>
			</section>
