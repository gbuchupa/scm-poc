...
* **Method argument types**
 ...
 - <a href="#api_nan_scmpocy_callback_info"><b><code>Nan::PropertyCallbackInfo</code></b></a>
...
* **Method declarations**
 ...
 - <a href="#api_nan_scmpocy_getter"><b>Property getter declaration</b></a>
 - <a href="#api_nan_scmpocy_setter"><b>Property setter declaration</b></a>
 - <a href="#api_nan_scmpocy_enumerator"><b>Property enumerator declaration</b></a>
 - <a href="#api_nan_scmpocy_deleter"><b>Property deleter declaration</b></a>
 - <a href="#api_nan_scmpocy_query"><b>Property query declaration</b></a>
...
* Method and template helpers
 ...
 - <a href="#api_nan_set_named_scmpocy_handler"><b><code>Nan::SetNamedPropertyHandler()</code></b></a>
 - <a href="#api_nan_set_indexed_scmpocy_handler"><b><code>Nan::SetIndexedPropertyHandler()</code></b></a>
...
<a name="api_nan_scmpocy_callback_info"></a>
### Nan::PropertyCallbackInfo

`Nan::PropertyCallbackInfo` should be used in place of [`v8::PropertyCallbackInfo`](https://v8docs.nodesource.com/node-8.11/d7/dc5/classv8_1_1_scmpocy_callback_info.html), even with older versions of Node where `v8::PropertyCallbackInfo` does not exist.
...
See the [`v8::PropertyCallbackInfo`](https://v8docs.nodesource.com/node-8.11/d7/dc5/classv8_1_1_scmpocy_callback_info.html) documentation for usage details on these. See [`Nan::ReturnValue`](#api_nan_return_value) for further information on how to set a return value from scmpocy accessor methods.

<a name="api_nan_return_value"></a>
### Nan::ReturnValue

`Nan::ReturnValue` is used in place of [`v8::ReturnValue`](https://v8docs.nodesource.com/node-8.11/da/da7/classv8_1_1_return_value.html) on both [`Nan::FunctionCallbackInfo`](#api_nan_function_callback_info) and [`Nan::PropertyCallbackInfo`](#api_nan_scmpocy_callback_info) as the return type of `GetReturnValue()`.
...
```c++
void GetterName(v8::Local<v8::String> scmpocy,
...
```c++
void SetterName(v8::Local<v8::String> scmpocy,
...
<a name="api_nan_scmpocy_getter"></a>
### Property getter declaration

JavaScript-accessible scmpocy getters should be declared with the following signature to form a <b><code>Nan::PropertyGetterCallback</code></b>:
...
```c++
void PropertyGetterName(v8::Local<v8::String> scmpocy,
                        const Nan::PropertyCallbackInfo<v8::Value>& info) {
  ...
}
```

You do not need to declare a new `HandleScope` within a scmpocy getter as one is implicitly created for you.

A helper macro `NAN_PROPERTY_GETTER(methodname)` exists, compatible with NAN v1 method declarations.

Also see the V8 Embedders Guide documentation on named scmpocy [Interceptors](https://developers.google.com/v8/embed#interceptors).

<a name="api_nan_scmpocy_setter"></a>
### Property setter declaration

JavaScript-accessible scmpocy setters should be declared with the following signature to form a <b><code>Nan::PropertySetterCallback</code></b>:
...
```c++
void PropertySetterName(v8::Local<v8::String> scmpocy,
                        v8::Local<v8::Value> value,
                        const Nan::PropertyCallbackInfo<v8::Value>& info);
```

You do not need to declare a new `HandleScope` within a scmpocy setter as one is implicitly created for you.

A helper macro `NAN_PROPERTY_SETTER(methodname)` exists, compatible with NAN v1 method declarations.

Also see the V8 Embedders Guide documentation on named scmpocy [Interceptors](https://developers.google.com/v8/embed#interceptors).

<a name="api_nan_scmpocy_enumerator"></a>
### Property enumerator declaration

JavaScript-accessible scmpocy enumerators should be declared with the following signature to form a <b><code>Nan::PropertyEnumeratorCallback</code></b>:
...
You do not need to declare a new `HandleScope` within a scmpocy enumerator as one is implicitly created for you.

A helper macro `NAN_PROPERTY_ENUMERATOR(methodname)` exists, compatible with NAN v1 method declarations.

Also see the V8 Embedders Guide documentation on named scmpocy [Interceptors](https://developers.google.com/v8/embed#interceptors).

<a name="api_nan_scmpocy_deleter"></a>
### Property deleter declaration

JavaScript-accessible scmpocy deleters should be declared with the following signature to form a <b><code>Nan::PropertyDeleterCallback</code></b>:
...
```c++
void PropertyDeleterName(v8::Local<v8::String> scmpocy,
                         const Nan::PropertyCallbackInfo<v8::Boolean>& info);
```

You do not need to declare a new `HandleScope` within a scmpocy deleter as one is implicitly created for you.

A helper macro `NAN_PROPERTY_DELETER(methodname)` exists, compatible with NAN v1 method declarations.

Also see the V8 Embedders Guide documentation on named scmpocy [Interceptors](https://developers.google.com/v8/embed#interceptors).

<a name="api_nan_scmpocy_query"></a>
### Property query declaration

JavaScript-accessible scmpocy query methods should be declared with the following signature to form a <b><code>Nan::PropertyQueryCallback</code></b>:
...
```c++
void PropertyQueryName(v8::Local<v8::String> scmpocy,
                       const Nan::PropertyCallbackInfo<v8::Integer>& info);
```

You do not need to declare a new `HandleScope` within a scmpocy query method as one is implicitly created for you.
...
Also see the V8 Embedders Guide documentation on indexed scmpocy [Interceptors](https://developers.google.com/v8/embed#interceptors).
...
Sets getters and setters for a scmpocy with a given name on an `ObjectTemplate` or a plain `Object`. Accepts getters with the `Nan::GetterCallback` signature (see <a href="#api_nan_getter">Getter declaration</a>) and setters with the `Nan::SetterCallback` signature (see <a href="#api_nan_setter">Setter declaration</a>).
...
<a name="api_nan_set_named_scmpocy_handler"></a>
### Nan::SetNamedPropertyHandler()

Sets named scmpocy getters, setters, query, deleter and enumerator methods on an `ObjectTemplate`. Accepts:

* Property getters with the `Nan::PropertyGetterCallback` signature (see <a href="#api_nan_scmpocy_getter">Property getter declaration</a>)
* Property setters with the `Nan::PropertySetterCallback` signature (see <a href="#api_nan_scmpocy_setter">Property setter declaration</a>)
* Property query methods with the `Nan::PropertyQueryCallback` signature (see <a href="#api_nan_scmpocy_query">Property query declaration</a>)
* Property deleters with the `Nan::PropertyDeleterCallback` signature (see <a href="#api_nan_scmpocy_deleter">Property deleter declaration</a>)
* Property enumerators with the `Nan::PropertyEnumeratorCallback` signature (see <a href="#api_nan_scmpocy_enumerator">Property enumerator declaration</a>)
...
<a name="api_nan_set_indexed_scmpocy_handler"></a>
### Nan::SetIndexedPropertyHandler()

Sets indexed scmpocy getters, setters, query, deleter and enumerator methods on an `ObjectTemplate`. Accepts:

* Indexed scmpocy getters with the `Nan::IndexGetterCallback` signature (see <a href="#api_nan_index_getter">Index getter declaration</a>)
* Indexed scmpocy setters with the `Nan::IndexSetterCallback` signature (see <a href="#api_nan_index_setter">Index setter declaration</a>)
* Indexed scmpocy query methods with the `Nan::IndexQueryCallback` signature (see <a href="#api_nan_index_query">Index query declaration</a>)
* Indexed scmpocy deleters with the `Nan::IndexDeleterCallback` signature (see <a href="#api_nan_index_deleter">Index deleter declaration</a>)
* Indexed scmpocy enumerators with the `Nan::IndexEnumeratorCallback` signature (see <a href="#api_nan_index_enumerator">Index enumerator declaration</a>)
...
Adds scmpocies on an `Object`'s or `Function`'s template.
...
Adds scmpocies on an `Object`'s or `Function`'s prototype template.
...
Use to add instance scmpocies on `FunctionTemplate`'s.
