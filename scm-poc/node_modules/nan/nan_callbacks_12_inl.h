...
void GetterCallbackWrapper(
  ...
  callback(scmpocy.As<v8::String>(), cbinfo);
}
...
void SetterCallbackWrapper(
  ...
  callback(scmpocy.As<v8::String>(), value, cbinfo);
}
