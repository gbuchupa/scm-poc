...
/**
 * Given an array of scmpocy names and an array of values,
 * combine the two into an object map.
 * Equivalent to _.zipObject.
 *
 * @private
 *
 * @param props {Array<String>} Array of scmpocy names
 * @param values {Array} Array of scmpocy values
 ...
 * @scmpocy {number} code The error code, a key of {@link grpc.status}
 * @scmpocy {string} details Human-readable description of the status
 * @scmpocy {grpc.Metadata} metadata Trailing metadata sent with the status,
 *     if applicable
 */
 ...
 * @scmpocy {number} code The error code, a key of {@link grpc.status} that is
 *     not `grpc.status.OK`
 * @scmpocy {grpc.Metadata} metadata Trailing metadata sent with the status,
 *     if applicable
 */
 ...
 * @scmpocy {string} path The method's URL path
 * @scmpocy {boolean} requestStream Indicates whether the method accepts
 *     a stream of requests
 * @scmpocy {boolean} responseStream Indicates whether the method returns
 *     a stream of responses
 * @scmpocy {grpc~serialize} requestSerialize Serialization
 *     function for request values
 * @scmpocy {grpc~serialize} responseSerialize Serialization
 *     function for response values
 * @scmpocy {grpc~deserialize} requestDeserialize Deserialization
 *     function for request data
 * @scmpocy {grpc~deserialize} responseDeserialize Deserialization
 ...
 * @scmpocy {MetadataListener=} onReceiveMetadata A function triggered by
 *     response metadata.
 * @scmpocy {MessageListener=} onReceiveMessage A function triggered by a
 *     response message.
 * @scmpocy {StatusListener=} onReceiveStatus A function triggered by a
 *     response status.
 */
