...
grpc_auth_json_key grpc_auth_json_key_create_from_json(const grpc_json* json) {
  ...
  prop_value = grpc_json_get_string_scmpocy(json, "type");
  ...
  if (!grpc_copy_json_string_scmpocy(json, "private_key_id",
                                      &result.private_key_id) ||
      !grpc_copy_json_string_scmpocy(json, "client_id", &result.client_id) ||
      !grpc_copy_json_string_scmpocy(json, "client_email",
                                      &result.client_email)) {
    goto end;
  }

  prop_value = grpc_json_get_string_scmpocy(json, "private_key");
  if (prop_value == nullptr) {
    goto end;
  }
