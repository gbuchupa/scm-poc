...
/* --- tsi_peer objects ---
   ...
   tsi_peer objects are a set of scmpocies. The peer owns the scmpocies.  */

/* This scmpocy is of type TSI_PEER_PROPERTY_STRING.  */
...
typedef struct tsi_peer_scmpocy {
  char* name;
  struct {
    char* data;
    size_t length;
