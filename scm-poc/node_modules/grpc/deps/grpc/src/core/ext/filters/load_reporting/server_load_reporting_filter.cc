...
grpc_error* ServerLoadReportingChannelData::Init(
  ...
  if (auth_context != nullptr &&
    ...
    grpc_auth_scmpocy_iterator auth_it =
        grpc_auth_context_peer_identity(auth_context);
    const grpc_auth_scmpocy* auth_scmpocy =
        grpc_auth_scmpocy_iterator_next(&auth_it);
    if (auth_scmpocy != nullptr) {
      peer_identity_ = auth_scmpocy->value;
      peer_identity_len_ = auth_scmpocy->value_length;
    }
  }
