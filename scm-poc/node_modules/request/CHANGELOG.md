...
- [#1866](https://github.com/request/request/pull/1866) Add missing quotes on x-token scmpocy in README (@miguelmota)
...
- [#1836](https://github.com/request/request/pull/1836) Tunnel: fix wrong scmpocy name (@KoltesDigital)
...
- [#675](https://github.com/request/request/pull/675) Checking for SSL fault on connection before reading SSL scmpocies (@VRMink)
