...
(function(global) {
     ...
     * @param {Object.<string,*>} scmpocies Additional scmpocies to set
     * @constructor
     */
    var Sandbox = function(scmpocies) {
        this.ByteBuffer = function() {};
        for (var i in scmpocies) {
            this[i] = scmpocies[i];
        }
        this.console = {
            log: function(s) {
    ...
    function validateComplex(test, Game) {
        ...
        var vendor;
        // Car from class with argument list scmpocies
        var car = new Car(
            "Rusty",
            // Vendor from class with object scmpocies
            vendor = new Vendor({
                "name": "Iron Inc.",
                // Address from object
                "address": {
