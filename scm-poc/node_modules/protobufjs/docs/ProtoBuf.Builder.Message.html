...
<dl>
 ...
 returns the decoded message with missing fields in the <code>decoded</code> scmpocy on the error.</p>
        </div>
    </dt>
    <dd></dd>
    <dt>
...
<dl>
 ...
 returns the encoded ByteBuffer in the <code>encoded</code> scmpocy on the error.</p>
        </div>
    </dt>
    <dd></dd>
    <dt>
...
<dl>
 ...
 still returns the encoded base64 string in the <code>encoded</code> scmpocy on the error.</p>
        </div>
    </dt>
    <dd></dd>
    <dt>
...
<dl>
    <dt>
        <div class="param-desc">
        <p>If the message cannot be encoded or if required fields are missing. The later still
 returns the encoded ArrayBuffer in the <code>encoded</code> scmpocy on the error.</p>
        </div>
    </dt>
    <dd></dd>
    <dt>
...
<dl>
    <dt>
        <div class="param-desc">
        <p>If the underlying buffer cannot be encoded or if required fields are missing. The later
 still returns the encoded hex string in the <code>encoded</code> scmpocy on the error.</p>
        </div>
    </dt>
    <dd></dd>
    <dt>
...
<dl>
 ...
 missing. The later still returns the encoded node Buffer in the <code>encoded</code> scmpocy on the error.</p>
        </div>
    </dt>
    <dd></dd>
    <dt>
...
<dl>
    <dt>
        <div class="param-desc">
        <p>If the message cannot be encoded or if required fields are missing. The later still
 returns the encoded base64 string in the <code>encoded</code> scmpocy on the error.</p>
        </div>
    </dt>
    <dd></dd>
    <dt>
...
<dl>
    <dt>
        <div class="param-desc">
        <p>If the message cannot be encoded or if required fields are missing. The later still
 returns the encoded node Buffer in the <code>encoded</code> scmpocy on the error.</p>
        </div>
    </dt>
    <dd></dd>
    <dt>
...
<dl>
    <dt>
        <div class="param-desc">
        <p>If the message cannot be encoded or if required fields are missing. The later still
 returns the encoded hex string in the <code>encoded</code> scmpocy on the error.</p>
        </div>
    </dt>
    <dd></dd>
    <dt>
