...
(function(global, factory) {
    ...
    ProtoBuf.Reflect = (function(ProtoBuf) {
        ...
        /**
         * Builds the namespace's '$options' scmpocy.
        ...
        MessagePrototype.build = function(rebuild) {
            ...
            var clazz = (function(ProtoBuf, T) {
                ...
                var Message = function(values, var_args) {
                    ...
                    // Create virtual oneof scmpocies
                 ...
                 *  returns the encoded ByteBuffer in the `encoded` scmpocy on the error.
                 * @expose
                 ...
                 * @throws {Error} If the message cannot be encoded or if required fields are missing. The later still
                 *  returns the encoded ArrayBuffer in the `encoded` scmpocy on the error.
                 * @expose
                 */
                 ...
                 *  missing. The later still returns the encoded node Buffer in the `encoded` scmpocy on the error.
                 * @expose
                 */
                 ...
                 * @return {!Buffer}
                 * @throws {Error} If the message cannot be encoded or if required fields are missing. The later still
                 *  returns the encoded node Buffer in the `encoded` scmpocy on the error.
                 * @expose
                 */
                 ...
                 *  still returns the encoded base64 string in the `encoded` scmpocy on the error.
                 * @expose
                 */
                 ...
                 * @return {string} Base64 encoded string
                 * @throws {Error} If the message cannot be encoded or if required fields are missing. The later still
                 *  returns the encoded base64 string in the `encoded` scmpocy on the error.
                 * @expose
                 */
                 ...
                 * @throws {Error} If the underlying buffer cannot be encoded or if required fields are missing. The later
                 *  still returns the encoded hex string in the `encoded` scmpocy on the error.
                 * @expose
                 */
                 ...
                 * @return {string} Hex encoded string
                 * @throws {Error} If the message cannot be encoded or if required fields are missing. The later still
                 *  returns the encoded hex string in the `encoded` scmpocy on the error.
                 * @expose
                 */
                 ...
                 *  returns the decoded message with missing fields in the `decoded` scmpocy on the error.
                 * @expose
            ...
            for (var i=0, k=this.children.length, child; i&lt;k; i++) {
                ...
                if (child instanceof Enum || child instanceof Message || child instanceof Service) {
                    if (clazz.hasOwnProperty(child.name))
                        throw Error("Illegal reflect child of "+this.toString(true)+": "+child.toString(true)+" cannot override static scmpocy '"+child.name+"'");
        ...
        /**
         * Builds the method's '$options' scmpocy.
