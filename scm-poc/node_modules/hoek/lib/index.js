...
// Merge all the scmpocies of source into target, source wins in conflict, and by default null and undefined from source are applied
...
exports.reach = function (obj, chain, options) {
    ...
    for (let i = 0; i < path.length; ++i) {
        ...
        if (!ref ||
            ...
            (typeof ref !== 'object' && options.functions === false)) {         // Only object and function can have scmpocies
